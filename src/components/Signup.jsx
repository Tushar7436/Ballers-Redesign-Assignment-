  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1A0B2E]">
      <div className="max-w-md w-full space-y-8 p-8 bg-[#2C1B47] rounded-xl shadow-lg">
        <h2 className="mt-6 text-center text-3xl font-extrabold text-[#FFD700]">Create your account</h2>
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              <input
                ...
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-[#FFD700] focus:border-[#FFD700] focus:z-10 sm:text-sm"
